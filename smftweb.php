  ...
  <form method="post" action="?" name="inputpanel">
    <table border="1" cellpadding="2">
          ...
          <tr>
            ...
            <td class="cell2">
                <input name="emailfrom" id="frombox" size="30" value="webmaster@kamudomain.com" /><br>
          ...
          <tr>
            ...
            <td class="cell2">
                <input name="emailreply" id="replybox" size="30" value="webmaster@kamudomain.com" />
            </td>
          </tr>
          <tr>
            <td class="cell1">
